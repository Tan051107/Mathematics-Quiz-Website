...
while ($row = mysqli_fetch_assoc($results)) {
    ...
    $correctAnswer = $options[(int)$row["answer"]]; 
    $questions[] = [
        "id" => $row["questionid"],
...
<head>
    ...
    <style>
        ...
        .darkmode .input-container input { 
...
<body>
    ...
    <div class="quiz-container">
        ...
        <div class="input-container">
            <input type="text" class="answer-input" id="user-answer" placeholder="Type your answer here..." />
        </div>
    ...
    <script>
        ...
        function loadQuestion() {
            ...
            document.getElementById("user-answer").value = userAnswers[currentQuestionIndex] || "";
        ...
        function nextQuestion() {
            userAnswers[currentQuestionIndex] = document.getElementById("user-answer").value;

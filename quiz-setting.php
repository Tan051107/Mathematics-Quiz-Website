        ...
        <div class="edit-section">
            <nav class="edit-type-box">
                <ul class="edit-type-content">
                    ...
                    <li>
                        <a href="quiz-setting.php" class="edit-type current-page">Quizz Settings</a>
                    </li>
                    <li>
                ...
                <form action="" method="post" class="edit-details-form">
                    <div class="other-details">
                        ...
                        <div class="volume-section">
                            <p class="volume">0</p>
                            <input type="range" min="0" max="1" id="volume-slider" step="0.1" onchange="adjustVolume(this.value)">
